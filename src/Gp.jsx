...
const SHEET_XLSX_URL =
  "https://docs.google.com/spreadsheets/d/e/2PACX-1vRqLc_A-SMmit4JKlJtXNPHvvJmtXr4Vf32LV6orNNWH5VQXFJWVbljDhYGX_r69zxNNMnSM8SXoV1Y/pub?output=xlsx";

const ACCOUNTS_KEY = "accountsGpDataV1";
...
export default function GpManager() {
  const {
    value: accounts,
    ...
    try {
      ...
      const mapped = rows
        .map((r) => {
          ...
          const robiId = (r["GP Login ID"] || "").trim();
          const robiPw = (r["GP Password"] || "").trim();
